...
#define CH5_SIGNAL_IN  // INTERRUPT 1 = DIGITAL PIN 3 - use the interrupt number in attachInterrupt
#define CH5_SIGNAL_IN_PIN 3 // INTERRUPT 1 = DIGITAL PIN 3 - use the PIN number in digitalRead

#define NEUTRAL_THROTTLE 0 // this is the duration in microseconds of neutral throttle on an electric RC Car
...
//  attachInterrupt(CH5_SIGNAL_IN,calcInput,CHANGE);
